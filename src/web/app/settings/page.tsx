...
function SettingsInner() {
  ...
  async function load() {
    ...
    try {
      ...
      try {
        diagObj.rawJson = await r.clone().json()
      } catch {
        diagObj.rawText = await r.text()
      }
    } catch (e: any) {
  ...
  return (
    <div className="max-w-2xl p-4 space-y-4">
        ...
        <form className="space-y-4" onSubmit={save}>
          <div>
            ...
            <input
              ...
              onChange={(e) =>
                setData({ ...data, slot_duration_min: Number(e.target.value) || 0 })
              }
            />
          </div>
          ...
          <div>
            ...
            <input
              ...
              onChange={(e) =>
                setData({ ...data, reminder_minutes_before: Number(e.target.value) || 0 })
              }
            />
          </div>
      ...
      {/* Ссылка на настройки почты */}
      <div className="pt-4 border-t">
        <h3 className="font-medium mb-2">Другие настройки</h3>
        <ul className="text-sm space-y-1">
          <li>
            ...
            >
              Настройки SMTP (почтовый сервер)
            </a>
          </li>
        </ul>
      </div>
